...
description: "Cendra AI agents are configurable, property-aware AI agents that handle guest communication autonomously across WhatsApp and email. Each agent is trained on your property's knowledge base and follows guardrails you define."
---
...
- **Respond to guest inquiries 24/7** across WhatsApp Business, Gmail, and Outlook
