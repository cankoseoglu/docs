...
description: "Cendra AI agents are configurable, property-aware chatbots that handle guest communication autonomously across WhatsApp and email. Each agent is trained on your property's knowledge base and follows guardrails you define."
---

Cendra AI agents are configurable, property-aware chatbots that handle guest communication autonomously. Each agent is trained on your property's knowledge base — amenities, house rules, check-in procedures, local recommendations — and follows guardrails you define for tone, escalation rules, and restricted topics.
