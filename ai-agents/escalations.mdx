...
<Info>**Quick link:** [Open Agent Hub in Cendra →](https://app.cendra.ai/agents) — select your agent, then click the **Escalations** tab.</Info>
...
<Frame caption="Escalation rules — condition-based routing with Escalate and Answer & Escalate actions">
  <img src="/images/06-agent-escalations.png" />
</Frame>
